...
export default function HeroSection({ onSubmit, isDisabled }: HeroSectionProps) {
  return (
    ...
    >
      {/* Terminal icon badge */}
      <div className="flex items-center gap-2 text-neon-green mb-8 text-sm uppercase tracking-widest">
      ...
      <GlitchText
        ...
        className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-center mb-6 text-foreground leading-tight"
      />

      {/* Subheading */}
      <p className="text-muted text-center max-w-xl mb-16 text-sm sm:text-base md:text-lg">
      ...
      {/* Bottom decoration */}
      <div className="mt-20 text-muted/30 text-xs text-center">
